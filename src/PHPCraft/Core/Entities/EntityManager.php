...
namespace PHPCraft\Core\Entities;

use Evenement\EventEmitter;
use PHPCraft\API\Coordinates3D;
use PHPCraft\Core\Networking\Packets\DestroyEntityPacket;
use PHPCraft\Core\Networking\Packets\EntityMetadataPacket;
use PHPCraft\Core\Networking\Packets\EntityTeleportPacket;
use PHPCraft\Core\Networking\Packets\EntityVelocityPacket;
use PHPCraft\Core\Physics\PhysicsEngine;
